...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $txHash = $client->sendTransaction('mintTokenmissioncompleteeCO', []);
...
<body>
    ...
    const contractABI = [
        {
		"inputs": [],
		"name": "mintTokenmissioncompleteeCO",
		"outputs": [],
    ...
    const contractAddress = "0xB547aDb64c1E3e03e8204A952d7Ea3Ac5ADE392f";
    ...
    async function mintWithMetaMask() {
        ...
        try {
            const txReceipt = await contract.methods.mintTokenmissioncompleteeCO().send({ from: sender });
